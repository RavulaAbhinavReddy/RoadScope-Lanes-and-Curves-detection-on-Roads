...
video = cv2.VideoCapture(r"C:\Users\Abhinav\lane-detection-master\data\curved_lane.mp4")
out = cv2.VideoWriter(r"C:\Users\Abhinav\lane-detection-master\results\curve_lane_detection.avi",cv2.VideoWriter_fourcc(*'XVID'), 25, (1280,720))
