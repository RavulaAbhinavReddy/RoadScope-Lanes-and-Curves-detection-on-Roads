...
video = cv2.VideoCapture(r"C:\Users\Abhinav\lane-detection-master\data\straight_lane.mp4")
out = cv2.VideoWriter(r"C:\Users\Abhinav\lane-detection-master\results/straight_lane_detection.avi",cv2.VideoWriter_fourcc(*'XVID'), 25, (960,540))
